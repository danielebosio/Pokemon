...
function showCaughtList() {
    ...
    if (caught.length === 0) {
        ...
        // Funzione che inserisce i pokemon nella lista
        caught.forEach((pokemon, index) => {
            ...
            listItem.innerHTML = `
                <div style="display: flex; align-items: center;">
                    ...
                    <span style="flex-grow: 1;">${pokemon.name}</span>
    ...
    function removePokemon(index) {
        // Recuperare la lista attuale
        const caught = JSON.parse(localStorage.getItem('caughtPokemon')) || [];
    
        // Rimuovere il Pokémon dalla lista
        const removedPokemon = caught.splice(index, 1);
    
        // Aggiornare il localStorage con la lista aggiornata
        localStorage.setItem('caughtPokemon', JSON.stringify(caught));
