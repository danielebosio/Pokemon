...
async function fetchData() {
    try {
        ...
        const statistiche = document.getElementById("stats");
        const stats = data.stats.map(statsInfo => statsInfo.stat.name, statsInfo.stat.name ).join(', ');
        statistiche.textContent = `Statistiche: ${stats.charAt(0).toUpperCase() + stats.slice(1)}`;
